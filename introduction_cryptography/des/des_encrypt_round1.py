...
parser=argparse.ArgumentParser(
    ...
    key is 48-bit string with key input for round 1 after the steps 'PC1' and 'Transformation1'.
    
    Both values can also be generated by entering the following options, when asked via stdin:
...
# check inputs
if len(cleartext) != 64 or len(k1) != 48:
